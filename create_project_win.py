...
# Windows-style path configuration， your desired project root
# the created project will be in the developer folder as the example
...
def check_prerequisites():
    ...
    prerequisites = {
        "python": f"Python {PYTHON_ENV_VER}",
        "conda": "Conda",
        "git": "Git",
...
"""
        ...
        if is_gh_installed():
            ...
            print(
                f"   git remote add origin git@github.com:Zakk-Yang/{project_name}.git"
            )
